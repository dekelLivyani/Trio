...
export default {
  ...
  created() {
    ...
    console.log("this.cardsFilterBy.timeLeft", this.cardsFilterBy.timeLeft);
    this.filterIsDueDateFilterActive(this.cardsFilterBy.timeLeft);
    this.searchCards;
  ...
  methods: {
    ...
    async remove() {
      ...
      if (this.board._id === "60fe8d8a9dc7b4d56dc56006") {
        const msg = {
          txt: "The main board cannot be deleted.",
          type: "error",
        };
        try {
